...
<nav class="navbar">
    ...
    <main>
        ...
        <div class="song-add">
            ...
            <h1 class="h1">Edit Song</h1>
            
            <form class="form" action="/includes/form-edit.php" method="POST">
                <div class="form__control">
                    <label for="title" class="form__label">Title</label>
                    <input id="title" type="text" name="title" class="form__input" value="<?php echo $item["title"]; ?>" />
                </div>

                <div class="form__control">
                    <label for="artist" class="form__label">Artist</label>
                    <input id="artist" type="text" name="artist" class="form__input" value="<?php echo $item["artist"]; ?>" />
                </div>

                <div class="form__control">
                    <label for="song_lyrics" class="form__label">Lyrics</label>
                    <textarea id="song_lyrics" name="song_lyrics" class="form__input"><?php echo strip_tags($item["song_lyrics"]); ?></textarea>
                </div>
